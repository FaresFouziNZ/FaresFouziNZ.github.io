...
export default function Header() {
  return (
    <header className="relative bg-gradient-to-r from-blue-500 to-blue-700 py-16 text-center">
      ...
      <div className="container relative z-10 mx-auto flex flex-col items-center px-4 md:flex-row md:items-start md:space-x-6">
        ...
        <div className="mt-6 text-left md:mt-0 self-center">
          ...
          <div className="flex gap-4">
            <Link
              className="mt-8 inline-block rounded-lg bg-white px-8 py-4 font-semibold text-blue-700 shadow-lg transition-colors duration-200 hover:bg-gray-100 hover:shadow-xl"
